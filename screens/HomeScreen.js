...
const styles = StyleSheet.create({
    ...
    headerTitle: { fontSize: 32, fontWeight: "800", color: "#FFFC00" },
    ...
    roomIconText: { color: "#FFFC00", fontSize: 16, fontWeight: "700" },
    roomInfo: { flex: 1 },
    roomName: { color: "#FFFFFF", fontSize: 18, fontWeight: "700", marginBottom: 4 },
    roomSubtext: { color: "#888888", fontSize: 13 },
    chevron: { color: "#555555", fontSize: 24 },
    ...
    fabIcon: { color: "#000000", fontSize: 32, fontWeight: "500", bottom: 2 },
    ...
    modalCloseText: { color: "#FFFC00", fontSize: 16, fontWeight: "700" },
    label: { fontSize: 11, fontWeight: "800", color: "#FFFC00", letterSpacing: 1.5, marginBottom: 8 },
    input: {
        backgroundColor: "#2E2E2D",
        borderRadius: 12,
    ...
    joinButtonText: { color: "#000000", fontSize: 17, fontWeight: "800" },
});
